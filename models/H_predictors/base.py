...
class BasePredictor(BaseModule, metaclass=ABCMeta):
    """Base class for H matrix predictors."""

    def __init__(self, init_cfg=None):
        super(BasePredictor, self).__init__(init_cfg)

    @auto_fp16(apply_to=('imgs1', 'imgs2',))
